...
class NotificationAdapter extends FirebaseRecyclerAdapter<NotificationModel, NotificationAdapter.myviewholder> {
    ...
    public NotificationAdapter(@NonNull FirebaseRecyclerOptions<NotificationModel> options, NotificationAdapter.RecyclerViewClickListener listener) {
        super(options);
        this.listener = listener;
    }

    @Override
    protected void onBindViewHolder(@NonNull NotificationAdapter.myviewholder holder, int position, @NonNull NotificationModel NotificationModel) {
